Pod::Spec.new do |s|
  ...
  s.homepage = 'https://github.com/ironforward/SDWebImage'
  s.author = { 'thepopco' => 'admin@thepopco.com' }
  s.source = { :git => 'https://github.com/ironforward/SDWebImage.git', :tag => s.version.to_s }
